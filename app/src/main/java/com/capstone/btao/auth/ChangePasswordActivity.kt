package com.capstone.btao.auth
...
import com.capstone.btao.databinding.ActivityChangePasswordBinding
        ...
        call.enqueue(object : Callback<AuthRequest?> {
            override fun onResponse(call: Call<AuthRequest?>, response: Response<AuthRequest?>) {
                ...
                if (!responseFromAPI?.profile?.username.isNullOrEmpty()){
                    ...
                    startActivity(Intent(this@ChangePasswordActivity, MainActivity2::class.java))
                    finish()
                }
            }
